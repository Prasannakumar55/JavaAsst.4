...
// 7. You are provided an array of integers and you have to increment all array elements by 1 and then print whole array. You have to complete Inc_Arr. No need to take any input.
...
function Unique_Shirts (arr,N) {
 ...
 // 10. Congratulations on making up to this question. Let us give you a fairly simple array problem to solve. If you know how to iterate through the array, you will easily be able to solve this.The problem statement is simple- given N elements, find the minimum and maximum numbers among those elements.
...
function Birthday_Game(arr,D ,M) {
  ...
  let count=0;
    for(let i=0; i<arr.length-1; i++){
      ...
      if (array1.length === M){
        let summ = array1.reduce((a,b) =>a + b,0);
        if (sum === D){
          count=count+1;
        }
      }
